...
ActiveRecord::Schema.define(version: 2019_09_27_120624) do
  ...
  create_table "exercises_types", id: false, force: :cascade do |t|
    t.integer "exercise_id", null: false
    t.integer "type_id", null: false
    t.index ["exercise_id", "type_id"], name: "index_exercises_types_on_exercise_id_and_type_id"
    t.index ["type_id", "exercise_id"], name: "index_exercises_types_on_type_id_and_exercise_id"
  end
  ...
  add_foreign_key "users_workouts", "users"
  add_foreign_key "users_workouts", "workouts"
end
